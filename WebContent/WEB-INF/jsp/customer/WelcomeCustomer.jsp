		...
		<div class="form">
			...
			<form:form id="hotelSearchForm" modelAttribute="trip"
				...
				<form:select class="select-style" id="countryDropDown"
					path="countryId" items="${countriesList}" itemValue="id"
					itemLabel="name" required="required" cssStyle="width:420px"></form:select>
				<br>
				<br>
				<p class="contact">
					<form:label path="cityId">City</form:label>
				</p>
				<form:select class="select-style" path="cityId" id="cityDropDown"
				...
				<form:input type="date" path="startDate" id="startDate"
					required="required" min="${todaysDate}"></form:input>
				<p class="contact">
